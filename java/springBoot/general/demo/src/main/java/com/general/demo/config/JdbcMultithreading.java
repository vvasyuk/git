package com.general.demo.config;
...
@Component
@Profile("jdbcMultithreading")
public class JdbcMultithreading implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("Running JdbcMultithreading");
