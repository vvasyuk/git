package general.abasics.collections.immutable.seq.indexedSeq
...
object vectorTest {
  def main(args: Array[String]): Unit = {
    ...
    assert(x.collect { case Some(i) => i } == Vector(1, 3)) // applies partial func, returning elements, fir which func is defined
